...
NsgThesis::Application.config.session_store :cookie_store, key: '_nsgthesis_session'

NsgThesis::Application.config.session = {
...
# Test310::Application.config.session_store :active_record_store
